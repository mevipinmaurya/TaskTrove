...
const RegistrationPage = () => {
    ...
    return (
        <div className='w-full flex justify-center items-center flex-col p-5 mt-7'>
            <div className='w-1/3 p-7 flex flex-col gap-4 rounded-lg shadow-lg border-2 border-slate-800'>
                ...
                <div className='flex justify-end'>
                    <button className="btn btn-active bg-green-600 text-black text-lg flex justify-center align-middle items-center hover:bg-green-700">{state}</button>
                </div>
